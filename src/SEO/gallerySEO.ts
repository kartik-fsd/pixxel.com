...
export const gallerySEO: SEOProps = createSEO({
    ...
    keywords: "photography studio nagpur, photo shoot locations, pre-wedding shoot venues, fashion photography sets, video production locations, premium photo studio, pixxel city",
